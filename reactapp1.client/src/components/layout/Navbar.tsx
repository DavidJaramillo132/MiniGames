...
function Navbar({ onlineCount, gameOnlineCount }: NavbarProps) {
  ...
  return (
    <header className="relative z-10 mx-auto grid w-full max-w-[1360px] grid-cols-[1fr_auto_1fr] items-center gap-3 px-6 py-6 max-[900px]:grid-cols-1 max-[900px]:justify-items-start max-sm:px-4">
      ...
      <div className="inline-flex items-center gap-3 rounded-full border border-[rgba(134,240,190,0.28)] bg-[rgba(134,240,190,0.10)] px-4 py-2 text-[1rem] text-[#d9fef1] shadow-[0_0_24px_rgba(134,240,190,0.06)]">
        ...
        <span className="font-medium">{t('playersOnline', { count: onlineCount })}</span>
